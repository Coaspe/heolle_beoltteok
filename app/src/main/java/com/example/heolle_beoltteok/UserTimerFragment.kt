...
class UserTimerFragment : Fragment() {
    ...
    var binding2: UsertimerrowBinding?=null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding2 = UsertimerrowBinding.inflate(layoutInflater, container, false)
    ...
    private fun firebaseDatainit() {
        ...
        binding!!.hour.text = String.format("%02d", rdb.child("hour").toString().toInt()/60)
        binding!!.minute.text = String.format("%02d", rdb.child("minute").toString().toInt()%60)
        binding!!.sec.text = "00"
